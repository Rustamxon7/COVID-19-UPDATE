            ...
            <div key={data.id} className="count">
              <NavLink className="nav__link" to={{ pathname: test, data }} exact>
                ...
                <div className="country">
                  <img className="filter-green" onError={(e) => ((e.target.onerror = null), (e.target.src = 'https://mapsvg.com/static/maps/geo-calibrated/angola.svg'))} src={countryMap(iso)} alt={iso} width="100" height="100" />
